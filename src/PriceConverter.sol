...
library PriceConverter {
    ...
    function getPrice(AggregatorV3Interface priceFeedAddress) public view returns(uint256){ //this FUNCTION return price of ** 1 ETH ** in USD 
    ...
    function getConversionRate(uint256 ethAmmount, AggregatorV3Interface priceFeedAddress) public view returns(uint256){ //this function converts the ETH ammount ** entered by user ** to USD
